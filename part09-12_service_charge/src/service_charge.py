...
# The service charge is calculated and subtracted only after the actual operation is completed
# (that is, after the amount specified has been added to or subtracted from the balance).
